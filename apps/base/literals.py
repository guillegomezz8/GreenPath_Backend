...
SUCCESSFULL_LOGIN = 'Inicio de sesión correcto.'
...
COMPANY_SETTINGS_UPDATED = 'Configuración de empresa actualizada correctamente.'
...
ROUTE_WEEK_GENERATION_IN_PROGRESS = 'Ya hay una generación de semana en curso para esta ruta.'
...
ROUTE_ZONE_DAYS_DUPLICATED = 'No se puede repetir el mismo día de la semana en zone_days.'
ROUTE_ZONE_WEEKDAY_INVALID = 'El weekday indicado no es válido.'
ROUTE_WORKER_COMPANY_INVALID = 'El trabajador seleccionado no pertenece a tu empresa.'
ROUTE_ZONE_CONFIG_UPDATED = 'Configuración de zonas actualizada correctamente.'
...
ROUTE_DAY_GOOGLE_NAVIGATION_READY = 'Enlace de navegación generado correctamente.'
...
ROUTE_DAY_GOOGLE_NAVIGATION_EMPTY = 'No hay paradas con ubicación para generar navegación.'
ROUTE_DAY_GOOGLE_HUB_REQUIRED = 'Debes configurar la nave (hub) para exportar la navegación.'
ROUTE_DAY_CLIENT_LOCATION_REQUIRED = 'No se puede generar la ruta porque hay clientes sin geoinformación completa: {clients}.'
ROUTE_OPTIMIZATION_NOT_REQUIRED = 'No es necesario reordenar una jornada con menos de dos paradas.'
ROUTE_OPTIMIZATION_HUB_REQUIRED = 'No se ha optimizado porque la empresa no tiene una nave con ubicación configurada.'
ROUTE_OPTIMIZATION_API_KEY_REQUIRED = 'No se ha optimizado porque Google Maps no está configurado.'
ROUTE_OPTIMIZATION_SUCCESS = 'Ruta optimizada correctamente con Google Maps.'
ROUTE_OPTIMIZATION_FALLBACK = 'Se ha conservado un orden alternativo porque Google Maps no pudo optimizar todos los tramos: {reason}.'
ROUTE_OPTIMIZATION_INVALID_RESULT = 'Google Maps devolvió un orden de paradas no válido.'
ROUTE_DAY_FINISH_DECISION_REQUIRED = 'Quedan paradas pendientes. Debes elegir cerrar la ruta diaria como parcial o cancelada.'
ROUTE_DAY_FINISH_CLOSE_ACTION_INVALID = 'La acción de cierre no es válida. Usa PARTIAL o CANCELED.'
