...
class APITest(TestCase):
    ...
    def test_retrieve_user_positive(self):
    ...
    def test_retrieve_user_negative(self):
    ...
    def test_update_user_positive(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(User.objects.all()[0].name, 'testUpdate')
    ...
    def test_partial_update_user_positive(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(User.objects.all()[0].username, 'testUserUpdate')

    def test_partial_update_user_negative(self):
        user = User.objects.create_user(
            username='testUser2',
            password='password',
            email='user2@example.com',
    ...
    def test_delete_user_positive(self):  
        ...
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(User.objects.all()[0].is_active, False)
